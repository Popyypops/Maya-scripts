...
class OpenFile(QMainWindow):
    def __init__ (self):
        ...
        self.uiFile = f'{self.ui_path}\\fenetre_open.ui'
   ...
   #BUTTONS
        self.openButton = self.ui.findChild(QtWidgets.QPushButton, "openButton")
        self.openButton.clicked.connect(self.launchOpen)
...
#Launch save :
    ...
    # PROJECT TYPE 
        ...
        if self.projectType == 'Asset':
            ...
            if self.version == 'Edit':
                ...
                if self.assetStep == 'Modé' or self.assetStep == 'Modé Finale':
                    self.file_path = f'{self.file_path}\\geo'

                elif self.assetStep == 'Rigg' or self.assetStep == 'Rigg Final':
        ...
        #SHOTS :
            ...
            elif self.shotStep == 'Blocking' or self.shotStep =='Primary' or self.shotStep =='Secondary':
    ...
    #SEARCH FILE
        ...
        chemin_scene = cmds.fileDialog2(fileMode=1, startingDirectory=self.file_path)
        cmd.file(chemin_scene[0], open=True, force=True)
